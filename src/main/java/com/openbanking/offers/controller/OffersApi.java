package com.openbanking.offers.controller;

import com.openbanking.offers.model.OBReadOffer1;
...
@Tag(name = "offers", description = "offers")
@RequestMapping(value = "")
public interface OffersApi {

	@Operation(summary = "Get Offers", operationId = "getOffers", description = "", tags = { "Offers", })

	@RequestMapping(value = "/offers", produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" }, method = RequestMethod.GET)
	default ResponseEntity<OBReadOffer1> getOffers(@Parameter(name = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750", required = true)
