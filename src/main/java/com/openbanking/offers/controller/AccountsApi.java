...
public interface AccountsApi {
	...
	@Operation(summary = "Get Offers", operationId = "getAccountsAccountIdOffers", description = "", tags = { "Offers", })

	@RequestMapping(
			value = "/accounts/{AccountId}/offers",
			produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" },
			method = RequestMethod.GET)
	default ResponseEntity<OBReadOffer1> getAccountsAccountIdOffers(@Parameter(name = "AccountId", required = true)
